...
public class OrdemDeServicoService {
	...
	private void validar(OrdemDeServico ordem) {
		...
		Preconditions.checkArgument(ordem.getPecasDoReparo().isEmpty(), "Não devem ser informadas peças na abertura da ordem");
	}
	...
	public OrdemDeServico buscarPor(
			@NotNull(message = "O id da ordem é obrigatório") @Min(value = 1, message = "O id da ordem deve ser maior que 0") Integer id) {
